...
<h3 >تسجيل الدخول</h3>
  ...
  <form action="admin/dashboard.php" method=POST>
    ...
    <span>  <a class="for" href="admin/emailforget.php" >هل نسيت كلمة المرور أضغط هنا</a><br><br></span>
    <span> <u> <a class="for" href="admin/user/homepageuser.php" >مستخدم جديد أضغط هنا </a></u></span>
